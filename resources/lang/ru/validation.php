...
return [
    "invalid_data"         => "Переданы недействительные данные.",
    "not_exists"           => "Поле :attribute не найдено.",
    "not_found_name"       => ":Attribute ':name' не найден(а).",
    "not_found"            => "HTTP 404 Не найдено.",
    ...
    "has_lowercase_letter" => ":Attribute должен содержать хотя бы одну маленькую букву.",
    "has_number"           => ":Attribute должен содержать хотя бы одну цифру от 0 до 9.",
    "has_uppercase_letter" => ":Attribute должен содержать хотя бы одну заглавную букву.",
    ...
    "login_input"          => "Логин может содержать только буквы и цифры.",
    "lt"                   => [
    ...
    "hex_color"            => ":Attribute должен быть передан в HEX формате.",
    "no_special_chars"    => ":Attribute не может состоять из специальных символов.",
    "string_or_array"      => ":Attribute должен быть строкой или массивом.",
    ...
    "required_comment"     => "Сообщение не может быть пустым.",
